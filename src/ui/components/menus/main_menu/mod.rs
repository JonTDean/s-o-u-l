...
use crate::ui::components::menus::main_menu::controller::scenario::new::ScenarioMeta;
use super::{setup_ui_camera, ui_runner};
...
impl Plugin for MainMenuPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(OnEnter(AppState::InGame), controller::scenario::new::init_new_world);
    }
}